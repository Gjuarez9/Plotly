function init() {
  ...
  d3.json("https://raw.githubusercontent.com/Gjuarez9/Plotly/main/samples.json").then((data) => {
...
function buildCharts(sample) {
  ...
  d3.json("https://raw.githubusercontent.com/Gjuarez9/Plotly/main/samples.json").then((data) => {
    ...
    var trace2 = {
        ...
        mode: "gauge+number",
        gauge: {
          axis: { range: [0, 10], tickwidth: 5, tickcolor: "black"},
          steps: [
    ...
    var gaugeLayout = { 
      width: 473, height: 450, margin: { t: 0, b: 0 }
    };
